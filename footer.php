                    ...
                    <div class="row sub-columns">
                        <div class="col-lg-2 col-sm-6 sub-two-right pl-lg-5 mt-lg-0 mt-sm-5 mt-4">
                            ...
                            <ul>
                                ...
                                <li><a href="blankpage.php"><span class="fa fa-angle-double-right mr-2"></span>Find a
                                        Tutor</a></li>
                                <li><a href="index.php"><span class="fa fa-angle-double-right mr-2"></span>Free
                                        Demo</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-sm-6 sub-two-right pl-lg-5 mt-lg-0 mt-sm-5 mt-4">
                            ...
                            <ul>
                                ...
                                <li><a href="blankpage.php"><span class="fa fa-angle-double-right mr-2"></span>Terms
                                        of Services</a></li>
                            </ul>
                        </div>
                            ...
                            <div class="column2">
                                ...
                                <div>
                                    <p class="contact-para"><span class="fa fa-map-marker" aria-hidden="true"></span><a
                                            href='contact.php#map'>Radaur, Haryana</a></p>
                                </div>
                            </div>
                        </div>
