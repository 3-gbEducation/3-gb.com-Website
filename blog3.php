...
<body>
    ...
    <body>
        ...
        <section class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold text-white mb-sm-3 mb-2">Blog Single</h4>
                        ...
                        <div class="col-lg-8">
                            <div class="single-bottom-blog">
                                <div class="top-bg bg-img">
                                    <img src="https://i.ibb.co/zR813xk/thomas-park-6-Me-Pt-A9-EVDA-unsplash-1.jpg" alt="" class="img-fluid img-responsive" />
                                </div>
                                <div class="bottom-grid mt-4 pt-md-2">
                                    ...
                                    <h3>Challenges faced by Students in Online Learning</h3>
                                    <p>The spread of COVID-19 has forced millions of students and teachers to move their communication online. The schools
                                        ...
                                        and along with the suggestions to overcome them..</p>
                                        <div class="container mb-4 justify-content-center">
                                        <div class="column">
                                            <div class="box13">
                                                <a href="#gallery-36"><img src="https://i.ibb.co/Gdrvd39/brad-neathery-n-Py0-X4xew60-unsplash.jpg" alt="" class="img-fluid" /></a>
                                            </div>
                                        </div>
                                    </div>
                                    <ol>
                                        <li>
                                            ...
                                            <p>Many students find difficulty in managing their time with online learning. Online learning is completely
                                                ...
                                                in adjusting to the time required for online learning.</p>
                                            <h5><b>How to overcome the challenge?</b></h5>
                                            <p>
                                        ...
                                        <li>
                                            ...
                                            <p>Students lack effective communication skills during online learning. Teachers give assignments
                                                ...
                                                themselves via live chats, emails or text messages.</p>
                                            <h5><b>How to overcome the challenge?</b></h5>
                                            <p>To overcome this problem, 3-GB Education is offering O3 Education,i.e.,One-On-One Education. So, there will be
                                                only one student and one tutor in the class and student can easily interact and communicate. It will also increase
                                                the productivity of Student.</p>
                                        </li>
                                        <li>
                                            <h4><b>Distraction</b></h4>
                                            <p>Learning from home is an amazing experience. You might expect things around you to be like a school
                                            ...
                                            <h5><b>How to overcome the challenge?</b></h5>
                                            <p>You should inform your parents and friends about the time of online learning so that there will be
                                                ...
                                                pay attention and Learning will increase. </p>
                                        </li>
                                        <li>
                                            <h4><b>Feedback</b></h4>
                                            <p>Every student needs feedback for their performance during the learning process so that they can improve
                                            ...
                                            <h5><b>How to overcome the challenge?</b></h5>
                                            <p>With 3-GB Education, tutor can provide easy feedback in class only, Student need not to wait for weeks.Teachers
                                                can give your personalized guidance for improvement and identify your weaknesses and strengths. You
                                                can improve your learning pattern based on the feedback. </p>
                                        </li>
                                    </ol>
                                    <div class="container mb-4 justify-content-center">
                                        <div class="column">
                                            <div class="box13">
                                                <a href="#gallery-36"><img src="https://i.ibb.co/t4SxJsm/chase-clark-d-Gq-WUPPesr-Q-unsplash.jpg" alt="" class="img-fluid" /></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="buttons-singles">
                                        ...
                                        <a href="#google-plus"><span class="fa fa-google-plus" aria-hidden="true"></span></a>
                                        <a href="#pinterest"><span class="fa fa-pinterest-p" aria-hidden=" true"></span></a>
                                    </div>

                                    <div class="single-pagination clearfix">
                                        <a class="prev-post pull-left" href="blog.php"><span class="fa fa-arrow-left" aria-hidden="true"></span>
                                            Back to Blogs</a>
                                        ...
                                        <div class="media mt-4 bod-1">
                                            ...
                                            <div class="media-body">
                                                <div class="medi-top mb-2">
                                                    <a href="#URL" class="name mt-0">John smi</a>
                                                ...
                                                <a href="#reply" class="rep">Reply</a>
                                    ...
                                    <div class="reply mt-5">
                                        <h3 class="post-title py-3 mb-2">Add a Comment</h3>
                                        <form action="#" method="POST">
                                            <div class="form-group reply">
                                                ...
                                                <div class="text-right">
                                                    <button class="btn btn-style btn-style-secondary mt-4" type="submit">Post
                                                        Now</button>
                                                </div>
                                            </div>
                                        </form>
