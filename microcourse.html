...
<body>
            ...
            <div class="top-content-w3ls d-flex align-items-center justify-content-between">
                <div class="top-headers">
                    <ul>
                        ...
                        <li>
                            <i class="fa fa-phone"></i><a href="tel:+919350227009">+91 9350227009</a>
                        </li>
                        <li>
                            <i class="fa fa-envelope"></i><a href="mailto:help.3gb@gmail.com">help.3gb@gmail.com</a>
                        </li>
                    </ul>
                </div>
                <div class="top-headers top-headers-2">
                    <ul>
                        <li>
                            <a href="https://wa.me/919350227009"><i class="fa fa-whatsapp"></i></a>
                        </li>
                        <li>
                            <a href="https://twitter.com/Shivangigarg160"><span class="fa fa-twitter"></span></a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/3gbeducation/"><span class="fa fa-instagram"></span></a>
                        </li>
                        <li class="mr-0">
                            <a href=" https://www.linkedin.com/company/3-ground-breakers"><span
            ...
            <nav class="navbar navbar-expand-lg stroke">
                <h1>
                    <a class="navbar-brand d-flex align-items-center" href="index.html">
                        <img src="assets/images/3gblogo.png" height='35px' alt="3-gb logo" class="mr-1" /></a>
                </h1>
                    ...
                    <ul class="navbar-nav ml-lg-auto">
                        <li id="menu-item-22"
                            ...
                            <a class="nav-link dropdown-toggle" data-toggle='dropdown' id="navbar-dropdown-menu-link-21"
                                aria-haspopup="true" aria-expanded="false">Find Your Teacher <i
                                    class="fa fa-angle-down"></i></a>
                            <div class="sub-menu dropdown-menu" aria-labelledby="navbar-dropdown-menu-link-21">
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-12">Class 1-4</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-32">Class 5-8</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-35">Class 9-10</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-39">Class 11-12</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-40">Programming</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-41">Artificial
                                    Intelligence</a>
                            </div>
                        </li>
                        <!-- <li id="menu-item-23"
                            ...
                            <a class="nav-link dropdown-toggle" data-toggle='dropdown' id="navbar-dropdown-menu-link-21"
                                aria-haspopup="true" aria-expanded="false">Study Material <i
                                    class="fa fa-angle-down"></i></a>
                            <div class="sub-menu dropdown-menu" aria-labelledby="navbar-dropdown-menu-link-21">
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-13">Notes</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-33">Text Books</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-36">Text Book Solutions</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-42">Sample Papers Solutions</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-43">Short Video Lectures</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-44">Practice Quiz</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-45">Youtube</a>
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-46">Kid Creatives</a>
                                
                            </div>
                        </li> -->
                        <li class="nav-item">
                            <a class="nav-link" href="blankpage.html">Study Material</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="blankpage.html">Micro Courses</a>
                        </li>
                        <li id="menu-item-21"
                            class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-21 nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle='dropdown' id="navbar-dropdown-menu-link-21"
                            ...
                            <div class="sub-menu dropdown-menu" aria-labelledby="navbar-dropdown-menu-link-21">
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-11">Blogs</a>
                                <!-- <a href="blankpage.html" class="dropdown-item" id="menu-item-30">Latest Updates</a> -->
                                <a href="blankpage.html" class="dropdown-item" id="menu-item-34">About Us</a><a
                                    href="contact.html" class="dropdown-item" id="menu-item-38">Contact Us</a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <div class="menu-icon">
                                <a href="login.html" class="nav-link"><i class="fa fa-user"></i></a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <div class="nav-link" id="search-icon"><i class="fa fa-search"
                                    onclick="displaySearch()"></i></div>
                        </li>
                        <div class="search-right ml-lg-3" id='search-bar'>
    ...
    <div class="inner-banner">
        ...
        <div class="container-fluid d-flex justify-content-end">
            <div class="col-lg-4 free-class-form mt-lg-4 mt-sm-5" style="height: fit-content;">
                <div class="contact-form-sec pt-5">
                    <p class="free-class-form-header" style="color: black;">Book a <span>Demo Class</span></p>
                    <div class="contact-block">
                        <div class="col-sm-12 mt-4 pl-lg-4 form-div">

                            <form id="DemoClassForm" method="POST" action="https://formsubmit.co/demo.3gb@gmail.com">
                                ...
                                <div class="tab">
                                    <input placeholder="Mobile Number..." oninput="this.className = ''" name="phone"
                                        required>
                                    <input placeholder="Language Preference" oninput="this.className = ''" name="lang"
                                        required>
                                </div>
                                <div class="tab">
                                    <input placeholder="Syllabus" oninput="this.className = ''" name="syllabus"
                                        required>
                                    <input placeholder="Class" oninput="this.className = ''" name="class" required>
                                </div>

                                <div style="overflow:auto;">
                                    <div style="float:right;">
                                        <button class="btn btn-style btn-style-secondary" type="button" id="prevBtn"
                                            onclick="nextPrev(-1)">Previous</button>
                                        <button class="btn btn-style btn-style-secondary" type="button" id="nextBtn"
    ...
    <div class="w3l-grids-block-5 w3l-grids-block-6 py-5">
        <div class="container py-md-5 py-4">
            <div class="title-heading-w3 text-center mx-auto mb-5 pb-sm-4">
                <h3 class="title-main">Our <span>Micro Courses</span></h3>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mt-5">
                    <div class="blog-card-single">
                        <div class="grids5-info position-relative">
                            ...
                            <div class="meta-list">
                                <a href="blankpage.html">Marketing</a>
                                <a href="blankpage.html">Edu</a>
                            </div>
                            <div class="course-price-item">
                                <h6>$499</h6>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mt-5">
                    <div class="blog-card-single">
                        <div class="grids5-info position-relative">
                            ...
                            <div class="meta-list">
                                <a href="blankpage.html">Study</a>
                                <a href="blankpage.html">Accadamic</a>
                            </div>
                            <div class="course-price-item">
                                <h6>$289</h6>
                            </div>
                ...
                <div class="text-txt">
                    <div class="right-side">
                        ...
                        <div class="row align-items-center w3l-forms-9">
                            <div class="main-midd col-md-5">
                                <h4 class="title-head mb-lg-2">Subscribe Us to get latest Academic Updates </h4>
                                <p>Newsletter</p>
                            </div>
                    ...
                    <div class="row sub-columns">
                        <div class="col-lg-2 col-sm-6 sub-two-right pl-lg-5 mt-lg-0 mt-sm-5 mt-4">
                            <h6>Quick links</h6>
                            <ul>
                                <li><a href="blankpage.html"><span
                                            class="fa fa-angle-double-right mr-2"></span>About</a>
                                </li>
                                <li><a href="blankpage.html"><span class="fa fa-angle-double-right mr-2"></span>Micro
                                        Courses</a>
                                </li>
                                <li><a href="blankpage.html"><span class="fa fa-angle-double-right mr-2"></span>Find a
                                        Tutor</a></li>
                                <li><a href="index.html"><span class="fa fa-angle-double-right mr-2"></span>Free
                                        Demo</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-sm-6 sub-two-right pl-lg-5 mt-lg-0 mt-sm-5 mt-4">
                            <h6>Help & Support</h6>
                            <ul>
                                <li><a href="blankpage.html"><span class="fa fa-angle-double-right mr-2"></span>Live
                                        Chat</a></li>
                                <li><a href="blankpage.html"><span class="fa fa-angle-double-right mr-2"></span>Faq</a>
                                </li>
                                <li><a href="blankpage.html"><span
                                            class="fa fa-angle-double-right mr-2"></span>Support</a>
                                </li>
                                <li><a href="blankpage.html"><span class="fa fa-angle-double-right mr-2"></span>Terms
                                        of Services</a></li>
                            </ul>
                        </div>
                            ...
                            <div class="column2">
                                ...
                                <div>
                                    <p class="contact-para"><span class="fa fa-map-marker"
                                            aria-hidden="true"></span>Radaur, Haryana</p>
                                </div>
                            </div>
                        </div>
